...
import { User, Mail, Shield, Calendar, GraduationCap, Code } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-sm">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground font-medium">{user.major || "Undecided"}</p>
                <p className="text-xs text-muted-foreground">{user.year || "New Student"}</p>
              </div>
            </div>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span>Enrolled {new Date(user.createdAt).toLocaleDateString(undefined, { month: 'long', year: 'numeric' })}</span>
              </div>
            </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { label: "Course Load", value: "4 Courses", sub: "12 Credit Hours" },
          ...
          <div className="rounded-xl border bg-card shadow-sm overflow-hidden">
            ...
            <div className="p-12 text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Opens in 14 days. Ensure your prerequisites are met.</p>
              </div>
            </div>
          </div>
        </div>
